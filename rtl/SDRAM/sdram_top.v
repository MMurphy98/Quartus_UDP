...
module	sdram_top(
	...
	output [ 3:0] sdram_dqm                 //SDRAM 数据掩码
    );

//wire define
wire        sdram_wr_req;                   //sdram 写请求
wire        sdram_wr_ack;                   //sdram 写响应
wire [24:0]	sdram_wr_addr;                  //sdram 写地址
wire [31:0]	sdram_din;                      //写入sdram中的数据

wire        sdram_rd_req;                   //sdram 读请求
wire        sdram_rd_ack;                   //sdram 读响应
wire [24:0]	sdram_rd_addr;                  //sdram 读地址
...
assign	sdram_dqm = 4'b0000;                //读写过程中均不屏蔽数据线
