...
module sdram_fifo_ctrl(
	...
	input      [31:0] wrf_din,		     //写端口FIFO: 写数据	
	input      [24:0] wr_min_addr,	     //写SDRAM的起始地址
	input      [24:0] wr_max_addr,	     //写SDRAM的结束地址
 	input      [10:0] wr_length,		 //写SDRAM时的数据突发长度 
	input             wr_load,		     //写端口复位: 复位写地址,清空写FIFO 
                                         
    //用户读端口                         
	input             clk_read,		     //读端口FIFO: 读时钟
	input             rdf_rdreq,		 //读端口FIFO: 读请求 
	output     [31:0] rdf_dout,		     //读端口FIFO: 读数据
	input      [24:0] rd_min_addr,	     //读SDRAM的起始地址
	input      [24:0] rd_max_addr,	     //读SDRAM的结束地址
	input      [10:0] rd_length,		 //从SDRAM中读数据时的突发长度 
...
wire [11:0] wrf_use/*synthesis keep*/;                      //写端口FIFO中的数据量
wire [11:0] rdf_use/*synthesis keep*/;                      //读端口FIFO中的数据量
